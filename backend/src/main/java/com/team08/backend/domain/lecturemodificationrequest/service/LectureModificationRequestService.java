...
public class LectureModificationRequestService {
    ...
    public void createRequest(Long lectureId, Long instructorId, String description, MultipartFile videoFile) {
        ...
        mediaEncodingService.encodeModificationToHls(videoFile, targetDirName, lectureId, description);
    }
