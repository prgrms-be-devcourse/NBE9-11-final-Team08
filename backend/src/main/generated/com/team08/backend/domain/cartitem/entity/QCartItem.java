...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1094665527L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCartItem cartItem = new QCartItem("cartItem");

    public final com.team08.backend.domain.cart.entity.QCart cart;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.cart = inits.isInitialized("cart") ? new com.team08.backend.domain.cart.entity.QCart(forProperty("cart")) : null;
    }
